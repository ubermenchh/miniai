# AUTOGENERATED! DO NOT EDIT! File to edit: ../notebooks/02_datasets.ipynb.

# %% ../notebooks/02_datasets.ipynb 1
...
# %% ../notebooks/02_datasets.ipynb 23
def inplace(f):
    def _f(b):
        f(b)
        return b
...
# %% ../notebooks/02_datasets.ipynb 28
def collate_dict(ds):
    get = itemgetter(*ds.features)
    def _f(b): return get(default_collate(b))
    return _f

# %% ../notebooks/02_datasets.ipynb 32
...
# %% ../notebooks/02_datasets.ipynb 36
...
# %% ../notebooks/02_datasets.ipynb 40
...
# %% ../notebooks/02_datasets.ipynb 42
@fc.delegates(subplots)
def show_images(
...
# %% ../notebooks/02_datasets.ipynb 47
class DataLoaders:
